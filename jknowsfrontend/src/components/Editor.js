...
const Editor = (props) => {
            ...
            toolbar: [
                ...
                "edit-mode",
                {
                    ...
                    click:()=> {
                        ...
                        saveAnswer(0, 1, questionId,content,callback)
    ...
    return (
        <>
            ...
            {/* <ReactMarkdown className={'markdown-body'} children={markdownContent} remarkPlugins={[remarkMath,remarkGfm]} rehypePlugins={[rehypeKatex,rehypeRaw,]} escapeHtml={true}/> */}
        </>
    )
};

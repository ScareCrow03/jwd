...
import {Menu, Dropdown, Space, Button, Modal, Input, message, List, Avatar, Divider} from 'antd';
...
import {getQuestions, getUnansweredQuestion, getUserQuestion} from "../service/questionService";
...
export class MyQuestionView extends React.Component{
   ...
   fetchunquestion=()=>{
        ...
        getUserQuestion(userId,callback);
    ...
    return(
        ...
        <div className={"background"}>
            ...
            <Space wrap className={"smallbar"}>
                ...
                <div className={"btnbar"}>
                    <Link to={{
                        pathname:'/answer',
                         ...
                         <Button   className={"ansbtn"} shape="round" icon={<FormOutlined />} size="large" >
                          最新问题
                         </Button>
                     </Link>
                     <Link to={{
                ...
                <Button   className={"ansbtn"} shape="round" icon={<FireFilled />} size="large" type={"primary"}>
                    我的问题
                </Button>
                     </Link>
                     </div>
                ...
                <List
                    ...
                    <Button  icon={<StarOutlined />} onClick={()=>{this.handleFollow(item.questionId,1,0)}}>
                        ...
                        已收藏 {item.follow}
                            ...
                            //
                            //
                            //         <Button type={"primary"} size={"large"} icon={<HighlightOutlined />} className={"writebtn"} onClick={()=>handleInvite()}> 邀请回答  </Button>
                            //     </Link>
                            // }
                            >
                                <Link to={{
